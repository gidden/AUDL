...
- (void)viewDidLoad
{
    ...
    // Change button color
    _sidebarButton5.tintColor = [UIColor colorWithRed:0.0 green:122.0/255.0 blue:1.0 alpha:1.0];
    //_sidebarButton.tintColor = [UIColor colorWithWhite:0.96f alpha:0.2f];
    
    // Set the side bar button action. When it's tapped, it'll show up the sidebar.
    _sidebarButton5.target = self.revealViewController;
    _sidebarButton5.action = @selector(revealToggle:);
